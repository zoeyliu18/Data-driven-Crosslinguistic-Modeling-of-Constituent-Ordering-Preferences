			...
			if len(verbs) != 0:
				for verb in verbs:
					...
					if preps is not None:
						...
						original_content = pp1_lexical_head_idx - v_idx + pp2_lexical_head_idx - v_idx
						variant_content = pp1_lexical_head_idx - v_idx + pp2_len + pp2_lexical_head_idx - v_idx - pp1_len

						original_content_hudson = pp1_lexical_head_idx - v_idx - 1 + pp2_lexical_head_idx - v_idx - 1
						variant_content_hudson = pp1_lexical_head_idx - v_idx + pp2_len - 1 + pp2_lexical_head_idx - v_idx - pp1_len - 1

						original_function = pp1_function_head_idx - v_idx + pp2_function_head_idx - v_idx 
						variant_function = pp1_function_head_idx - v_idx + pp2_len + pp2_function_head_idx - v_idx - pp1_len

						original_function_hudson = pp1_function_head_idx - v_idx - 1 + pp2_function_head_idx - v_idx - 1
						variant_function_hudson = pp1_function_head_idx - v_idx - 1 + pp2_len + pp2_function_head_idx - v_idx - pp1_len - 1
...
########## Bootstrapping for comparisons of DLM based on function head, measured based on Hudson (1995) #############
				...
				with io.open(args.output + directory[3 : ] + '-en-content-statistics.txt', 'w', encoding = 'utf-8') as f:
				...
				with io.open(args.output + directory[3 : ] + '-en-content-hudson-statistics.txt', 'w', encoding = 'utf-8') as f:
				...
				with io.open(args.output + directory[3 : ] + '-en-function-statistics.txt', 'w', encoding = 'utf-8') as f:
				...
				with io.open(args.output + directory[3 : ] + '-en-function-hudson-statistics.txt', 'w', encoding = 'utf-8') as f:
				...
				with io.open(args.output + directory[3 : ] + '-en-len-diff.txt', 'w', encoding = 'utf-8') as f:
