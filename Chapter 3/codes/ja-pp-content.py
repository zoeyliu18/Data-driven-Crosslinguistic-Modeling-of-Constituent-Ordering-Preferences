...
########## Bootstrapping for comparisons of DLM based on function head, measured based on Hudson (1995) #############
				...
				with io.open(args.output + directory[3 : ] + '-ja-content-statistics.txt', 'w', encoding = 'utf-8') as f:
				...
				with io.open(args.output + directory[3 : ] + '-ja-content-hudson-statistics.txt', 'w', encoding = 'utf-8') as f:
				...
				with io.open(args.output + directory[3 : ] + '-ja-function-statistics.txt', 'w', encoding = 'utf-8') as f:
				...
				with io.open(args.output + directory[3 : ] + '-ja-function-hudson-statistics.txt', 'w', encoding = 'utf-8') as f:
				...
				with io.open(args.output + directory[3 : ] + '-ja-len-diff.txt', 'w', encoding = 'utf-8') as f:
