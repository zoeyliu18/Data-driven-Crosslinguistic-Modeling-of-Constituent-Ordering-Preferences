		...
		if tok[3] == 'ADP':
			if tok[7] == 'case':
				...
				if int(tok[0]) < int(verb_index): #the PP appears before the verb
					if head(tok[0], sentence) != None: #if the postposition has a head
						if int(tok[6]) < int(tok[0]): # if the head of the postposition is in front of the postposition

							if head(tok[6], sentence) == verb_index:
...
# get the dependents of prep_heads that are prepositions
...
def last_dependent(index, sentence):
	max_de = int(index)
	for tok in sentence:
		if tok[6] == index:
			if tok[7] != 'punct':
			...
			if len(verbs) != 0:
				...
				for verb in verbs:
					...
					if preps is not None:
						...
						pp1 = sent[min1 - 1 : max1]
						pp2 = sent[min2 - 1 : max2]
...
#				with io.open(args.output + directory[3 : ] + '-ja-original.txt', 'w', encoding = 'utf-8') as f:
#					for tok in original:
#						f.write(tok + '\n')

#				with io.open(args.output + directory[3 : ] + '-ja-variant.txt', 'w', encoding = 'utf-8') as f:
#					for tok in variant:
#						f.write(tok + '\n')

#				with io.open(args.output + directory[3 : ] + '-ja-pp1.txt', 'w', encoding = 'utf-8') as f:
#					for tok in pp1:
#						f.write(tok + '\n')

#				with io.open(args.output + directory[3 : ] + '-ja-pp2.txt', 'w', encoding = 'utf-8') as f:
#					for tok in pp2:
#						f.write(tok + '\n')

#				with io.open(args.output + directory[3 : ] + '-ja-base1.txt', 'w', encoding = 'utf-8') as f:
#					for tok in base1:
#						f.write(tok + '\n')

#				with io.open(args.output + directory[3 : ] + '-ja-base2.txt', 'w', encoding = 'utf-8') as f:
#					for tok in base2:
#						f.write(tok + '\n')

#				with io.open(args.output + directory[3 : ] + '-ja-tuples1.txt', 'w', encoding = 'utf-8') as f:
...
#				with io.open(args.output + directory[3 : ] + '-ja-tuples2.txt', 'w', encoding = 'utf-8') as f:
#					f.write('\t'.join(w for w in ['VERB_lemma', 'VERB_lexical', 'Prep_lemma', 'Prep_lexical', 'PP_head_lemma', 'PP_head_lexical', 'PP_head_POS', 'VERB_id', 'Head_id']) + '\n')
#					for tok in tuples2:
#						f.write('\t'.join(w for w in tok) + '\n')

#				with io.open(args.output + directory[3 : ] + '-ja-pp1-lemma.txt', 'w', encoding = 'utf-8') as f:
#					for tok in pp1_lemmas:
#						f.write(tok + '\n')

#				with io.open(args.output + directory[3 : ] + '-ja-pp2-lemma.txt', 'w', encoding = 'utf-8') as f:
#					for tok in pp2_lemmas:
#						f.write(tok + '\n')
				
#				with io.open(args.output + directory[3 : ] + '-ja-pro1.txt', 'w', encoding = 'utf-8') as f:
#					for tok in pp1_pro:
#						f.write(tok + '\n')

#				with io.open(args.output + directory[3 : ] + '-ja-pro2.txt', 'w', encoding = 'utf-8') as f:
#					for tok in pp2_pro:
#						f.write(tok + '\n')

#				with io.open(args.output + directory[3 : ] + '-ja-verb.txt', 'w', encoding = 'utf-8') as f:
#					for tok in verb:
#						f.write(tok + '\n')
				
				with io.open(args.output + directory[3 : ] + '-ja-full.txt', 'w', encoding = 'utf-8') as f:
...
'''
				...
				with io.open('/Users/Silverlining/Desktop/PP-new/' + directory[3 : ] + '-ja-statistics.txt', 'w', encoding = 'utf-8') as f:
